...
public class DetectedActivitiesActivity extends AppCompatActivity implements
        ConnectionCallbacks, OnConnectionFailedListener, ResultCallback<Status> {

    protected static final String TAG = "DetectedActiv";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detected_activities);

        boolean bool = init();
        if(!bool){
            L.toast(this, "Need Permissions");
            this.finish();
            return;
        }
        // Get the UI widgets.
        ...
        mGoogleApiClient = GoogleClientSingleton.buildClient(
                this, ActivityRecognition.API, this, this);
    }

    private boolean init(){
        return PermissionUtilities.getLocationPermissions(this);
    }
    ...
    public void onConnected(Bundle connectionHint) {
        L.m("Connected to GoogleApiClient");
        //Location location = dddd;
    }
    ...
    public void requestActivityUpdatesButtonHandler(View view) {
        ...
        ActivityRecognition.ActivityRecognitionApi.requestActivityUpdates(
                mGoogleApiClient, Constants.DETECTION_INTERVAL_IN_MILLISECONDS,
    ...
    public void onResult(Status status) {
        if (status.isSuccess()) {
            L.m("onResult hit with status as success");
    ...
    private boolean getUpdatesRequestedState() {
        return SharedPrefs.getBoolean(Constants.ACTIVITY_UPDATES_REQUESTED_KEY, false);
    }
    ...
    private void setUpdatesRequestedState(boolean requestingUpdates) {
        SharedPrefs.save(Constants.ACTIVITY_UPDATES_REQUESTED_KEY, requestingUpdates);
    }
    ...
    protected void updateDetectedActivitiesList(ArrayList<DetectedActivity> detectedActivities) {
        L.m("updateDetectedActivitiesList");
    ...
    class DetectedActivitiesAdapter extends ArrayAdapter<DetectedActivity> {
        ...
        protected void updateActivities(ArrayList<DetectedActivity> detectedActivities) {
            L.m("DetectedActivitiesAdapter.updateActivities()");
